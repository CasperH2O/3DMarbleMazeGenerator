...
class CaseSphereWithFlangeEnclosedTwoSides(CaseBase):
    def __init__(self):
        ...
        # Create parts
        (self.mounting_ring_clips, self.mounting_ring, self.internal_path_bridges, self.start_indicator, 
         self.mounting_ring_top, self.mounting_ring_bottom) = self.create_mounting_ring()
    ...
    def create_mounting_ring(self):
        ...
        internal_path_bridges.part = Part(internal_path_bridges.part.solids().sort_by(SortBy.VOLUME)[-count:])
